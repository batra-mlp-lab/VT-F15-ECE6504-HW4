...
X_train,y_train,im_train = hw4_util.batchify(question,answer,image,opt.batchSize)
-- imtrain contains the imgId
-- fc7_feat[imgId] will give the fc7 features
...
------------MY MODEL-----------------
model = nn.Identity()
-- need to use fc7 features. Look at nn.ParallelTable() for taking in 2 inputs. 
-- Table layers like JoinTable will help you concatenate the image feature in the beginning.
-- After you concatenate the image features in the beginning, the model is similar to the blind model. 
------MODEL DEF STARTS---------------
-------------------------------------
-------------------------------------
...
-- training
-- The below training code is similar to train_qa.lua. You will need to make minor modifications based on your model definition. 
